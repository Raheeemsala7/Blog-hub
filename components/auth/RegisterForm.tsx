          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className='border-secondary-foreground dark:bg-[#000000] focus-visible:border-secondary-foreground ' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className='dark:bg-[#000000] focus-visible:border-secondary-foreground' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className='dark:bg-[#000000] focus-visible:border-secondary-foreground' {...field} type="password" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
